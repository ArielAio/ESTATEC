...
confirmacaoSenhaInput.addEventListener("input", function() {
    ...
    if (senha !== confirmacaoSenha) {
        ...
        document.getElementById("alerta-senha").innerHTML = "<span style='color:red; font-weight:bold;'>As senhas não coincidem!<br> As senhas devem conter, ao menos, um dígito numérico e um caractere especial (*/-)</span>";
